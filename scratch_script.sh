...
## RESNET8 (Model will be trained 12 times with different permutations of losses and "loss-weight" hyper parameters (i.e. gamma, beta)
...
## RESNET32 (Model will be trained 12 times with different permutations of losses and "loss-weight" hyper parameters (i.e. gamma, beta)
...
## RESNET56 (Model will be trained 12 times with different permutations of losses and "loss-weight" hyper parameters (i.e. gamma, beta)
...
# CONVNETi (here i can be 2,4,6,8) (Model will be trained 12 times with different permutations of losses and "loss-weight" hyper parameters (i.e. gamma, beta)

# CONVNET 2
if [[ "$model" == *"convnet2"* ]]; then
this_model="convnet2"
# train scratch convnet2 on cross_entropy ####################################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet2 on NLL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet2 on FL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# CONVNET 6
if [[ "$model" == *"convnet6"* ]]; then
this_model="convnet6"
# train scratch convnet6 on cross_entropy ####################################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet6 on NLL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet6 on FL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# CONVNET 8
if [[ "$model" == *"convnet8"* ]]; then
this_model="convnet8"
# train scratch convnet8 on cross_entropy ####################################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet8 on NLL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet8 on FL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# CONVNET 10
if [[ "$model" == *"convnet10"* ]]; then
this_model="convnet10"
# train scratch convnet10 on cross_entropy ####################################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet10 on NLL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
...
# train scratch convnet10 on FL+MDCA ###########################
CUDA_VISIBLE_DEVICES=0 accelerate launch --mixed_precision fp16 train_scratch.py \
--dataset $dataset \
--model $this_model \
--lr 0.1 \
