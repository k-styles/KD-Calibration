...
if __name__ == "__main__":
    ...
    model_save_pth = f"{args.checkpoint}/{args.dataset}/{args.model}/{current_time}{create_save_path(args, mode='scratch')}"
    ...
    if accelerator.is_main_process:
        ...
        save_path_file = os.path.join(result_folder, "scratch_metrics.csv")
